class User < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :read_family, format: {with: /\A[ァ-ヶー－]+\z/, message: "Full-width katakana characters"}
    validates :read_first,  format: {with: /\A[ァ-ヶー－]+\z/, message: "Full-width katakana characters"}
    validates :birth
  end
